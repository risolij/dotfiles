...
clipboardy = spawn "rofi -modi \"\63053 :greenclip print\" -show \"\63053 \" -run-command '{cmd}' -theme ~/org/dev/dotfiles/.config/nixpkgs/packages/rofi/custom.rasi"
...
rofi_launcher = spawn "rofi -no-lazy-grab -show drun -modi run,drun,window -theme /home/req/org/dev/dotfiles/.config/nixpkgs/packages/rofi/custom.rasi -drun-icon-theme \"candy-icons\" "
