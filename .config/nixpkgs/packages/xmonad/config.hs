...
-- Xmobar Colors
xmobarTitleColor = "#ff79c6"
xmobarCurrentWorkspaceColor = "#ff79c6"
...
--
myLayout = spacingRaw True (Border 0 10 10 10) True (Border 10 10 10 10) True $ avoidStruts (gaps [(U, 20), (D, 20), (R, 20), (L,20)] $ ThreeColMid 1 (3/100) (1/2) ||| tiled ||| Mirror tiled ||| Full)
  where
...
--
main = do 
  xmproc <- spawnPipe "xmobar /home/req/.config/xmobar/.xmobarrc"
